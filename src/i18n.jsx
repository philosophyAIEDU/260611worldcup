...
const STRINGS = {
  ...
  'match.speedLabel': { ko: '⏱ 속도', en: '⏱ Speed' },
  'match.speed.slow': { ko: '느리게', en: 'Slow' },
  'match.speed.normal': { ko: '보통', en: 'Normal' },
  'match.speed.fast': { ko: '빠르게', en: 'Fast' },
  'match.speed.turbo': { ko: '아주 빠르게', en: 'Turbo' },
  'match.restOn': { ko: '☕ 휴식 켜짐', en: '☕ Breaks On' },
  'match.restOff': { ko: '⏭ 휴식 꺼짐', en: '⏭ Breaks Off' },
  'match.restHintHalves': {
    ko: '켜짐: 하프타임(45분)에 멈춰 전술을 조정합니다. 꺼짐: 멈추지 않고 끝까지 진행합니다.',
    en: 'On: pause at half-time (45′) to adjust tactics. Off: play through without stopping.',
  },
  'match.restHintQuarters': {
    ko: '켜짐: 각 쿼터 종료(23·45·68분)에 멈춰 전술을 조정합니다. 꺼짐: 멈추지 않고 진행합니다.',
    en: 'On: pause at each quarter break (23′/45′/68′). Off: play through without stopping.',
  },
